...
return new class extends Migration
{
    ...
    {
        // Create tabel absensi baru yang menggabungkan absendatang + absenpulang
        Schema::create('absensi', function (Blueprint $table) {
            ...
            $table->text('FOTO_DATANG')->nullable(); // Base64 encoded image
            ...
            $table->text('FOTO_PULANG')->nullable(); // Base64 encoded image
            ...
            $table->text('SURAT_IZIN')->nullable(); // Base64 encoded file
